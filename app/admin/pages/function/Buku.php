...
if ($_GET['act'] == "tambah") {
    ...
    $id_kategori = $_POST['kategoriBuku'];
    ...
    $sql = "INSERT INTO buku(judul_buku,kategori_buku,penerbit_buku,pengarang,tahun_terbit,isbn,j_buku_baik,j_buku_rusak)
        VALUES('" . $judul_buku . "','" . $id_kategori . "','" . $penerbit_buku . "','" . $pengarang . "','" . $tahun_terbit . "','" . $isbn . "', '" . $j_buku_baik . "', '" . $j_buku_rusak . "')";
    ...
    // PROCESS EDIT DATA
    $query = "UPDATE buku SET judul_buku = '$judul_buku', kategori_buku = '$id_kategori', penerbit_buku = '$penerbit_buku', 
