<header class="main-header">
    ...
    <a href="dashboard" class="logo" style="font-family: 'Quicksand', sans-serif">
        ...
        <span class="logo-mini"><b></b><img src="../../assets/dist/img/icon.png" class="img-circle" alt="Image" width="40" height="40"></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>SMAN 23 BDG </b><img src="../../assets/dist/img/icon.png" class="img-circle" alt="Image" width="40" height="40"></span>
    </a>
