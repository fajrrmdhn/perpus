                            ...
                            <section id="new">
                                ...
                                if ($hasil > 0) {
                                    ...
                                    <div class='alert alert-danger small'>
                                        Kamu saat ini telah mengajukan peminjaman buku sebanyak " . $hasil . " Buku
                                    </div>";
                                } else {
                                    //
                                }
                                ...
                                <form action="pages/function/Peminjaman.php?aksi=pinjam" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="form_prov" name="kategoriBuku" class="form-control">
                                        <option value="">-- Silahkan pilih kategori buku --</option>
                                        <?php 
                                        include 'config/database.php';
                                        $daerah = mysqli_query($koneksi,"SELECT * FROM kategori");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="form_kab" class="form-control" name="judulBuku">
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Buku</label>
                                        <input type="number" class="form-control" name="jumlahBukuPinjam"></input>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="alasanPeminjaman"?>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>*Jika Peminjaman -> (< 2 Hari Tidak Dikenakan Denda ; > 2 Hari Dikenakan Denda Rp 5.000 ; >= 2 Minggu Dikenakan Denda Rp 10.000)</label>
