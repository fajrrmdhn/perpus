                    ...
                    <div class="tab-content">
                            ...
                            <section id="new">
                                <form action="pages/function/Peminjaman.php?aksi=pengembalian" method="POST">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="judulBuku" require>
                                            <option selected disabled> -- Silahkan pilih buku yang akan di kembalikan -- </option>
                                            <?php
                                            include "../../config/koneksi.php";

                                            $fullname = $_SESSION['fullname'];
                                            $sql = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE nama_anggota = '$fullname' AND tanggal_pengembalian = ' ' AND konfirmasi = 'Di Konfirmasi'");
                                            while ($data = mysqli_fetch_array($sql)) {
                                            ?>
                                                <option value="<?= $data['judul_buku']; ?>" required> <?= $data['judul_buku']; ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="jumlahBukuKembali"></input>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kondisiBukuSaatDikembalikan" required>
                                            ...
                                            <!-- -->
                                            <option value="Baik">Baik (Tidak terkena denda tambahan)</option>
                                            <option value="Rusak">Rusak (Denda Tambahan 10.000)</option>
                                            <option value="Hilang">Hilang (Denda Tambahan 30.000)</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Hasil Literasi Buku</label>
                                        <input type="text" class="form-control" name="hasilLiterasi"? required>
                                    </div>
                                    <div class=" form-group">
                        ...
                        <div class="tab-pane" id="tgl-pengembalian">
                            <table class="table table-bordered" id="example1">
                                ...
                                $no = 1;
                                $fullname = $_SESSION['fullname'];
                                $query = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE nama_anggota = '$fullname' AND konfirmasi LIKE '%Di Konfirmasi%'");
                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= $row['jumlah_buku_pinjam']; ?></td>
                                            <td><?= $row['jumlah_buku_kembali']; ?></td>
